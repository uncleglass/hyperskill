...
class ParserUtilTest {
    ...
    @Test
    void shouldReturnObjectTextStatisticsWithCorrectValues_1() {
        //given
        final String text ="Readability is " +
        ...
        //when
        TextStatistics textStatistics = ParserUtil.parseToStatistics(text);

        //then
        assertEquals(580, textStatistics.getCharacters());
        assertEquals(108, textStatistics.getWords());
        assertEquals(6, textStatistics.getSentences());
    }

    @Test
    void shouldReturnObjectTextStatisticsWithCorrectValues_2() {
        //given
        final String text = "This is the page of the Simple English Wikipedia. " +
        ...
        //then
        assertEquals(476, textStatistics.getCharacters());
        assertEquals(100, textStatistics.getWords());
        assertEquals(10, textStatistics.getSentences());
    }

    @Test
    void shouldReturnObjectTextStatisticsWithCorrectValues_3() {
        //given
        final String text = "Gothic architecture are building designs, " +
        ...
        //then
        assertEquals(982, textStatistics.getCharacters());
        assertEquals(180, textStatistics.getWords());
        assertEquals(13, textStatistics.getSentences());
    }
}